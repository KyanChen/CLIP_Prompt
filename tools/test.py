...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs_my/detr_rs.py', help='test config file path')
    parser.add_argument('--checkpoint', default='results/detr/latest.pth', help='checkpoint file')
    parser.add_argument(
        '--work-dir',
