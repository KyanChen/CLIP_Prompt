...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs_my/Op1_CLIPPrompt_Crop_Img_VAW.py', help='test config file path')
    parser.add_argument('--checkpoint', default='results/EXP20221006_0/epoch_20.pth', help='checkpoint file')
