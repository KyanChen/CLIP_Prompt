...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs_my/rpn_r50_fpn_mstrain_vaw.py', help='test config file path')
    parser.add_argument('--checkpoint', default='results/EXP20220804_4/latest.pth', help='checkpoint file')
