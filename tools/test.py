...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs_my/CLIPPrompt_Proposal_VAW.py', help='test config file path')
    parser.add_argument('--checkpoint', default='results/EXP20220627_1/latest.pth', help='checkpoint file')
